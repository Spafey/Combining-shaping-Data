...
Somewhat predictably for a non-parametric sample simply jammed into an OLS regression, & regardless of F-values, no p-value in the regression model was greater than 0.85 (!)and relationships between data were therefore indistinguishable from chance occurence. As such this model provided little predictive value when trying to identify factors related to the total number of installs. 
